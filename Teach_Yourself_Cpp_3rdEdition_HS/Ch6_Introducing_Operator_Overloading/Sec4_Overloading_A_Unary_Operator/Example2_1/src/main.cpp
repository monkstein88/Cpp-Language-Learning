...
public:
	...
	coord& operator=(const coord& ob2);		// called when 'ob = ob' , by their respective (corresponding) elements . Keyword 'const' is used to indicate that the param is not be changed by the function.
	coord& operator=(const int& i); 			// called when 'ob = int' , by a (common) factor 'i' . Keyword 'const' is used to indicate that the param is not be changed by the function.
...
int main(){
	...
	// Check the pre-increment '++' overloading
	o1.get_xy(x, y);
	cout << "(o1) X: " << x << ", Y: " << y << "\n";
	...
	// Check the post-increment '++' overloading
	o1.get_xy(x, y);
	cout << "(o1) X: " << x << ", Y: " << y << "\n";
	otemp = o1++;
	cout << "otemp = o1++;" << "\n";
