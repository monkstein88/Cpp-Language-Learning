...
/*
	Example 1.: Any type of function can be in-lined, including functions that are member of classes.
				For example, here the member fnction 'divisible()' is in-lined for fast execution.
